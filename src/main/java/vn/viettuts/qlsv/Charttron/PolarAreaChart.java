...
package vn.viettuts.qlsv.Charttron;
        ...
        if (!list.isEmpty()) {
           DecimalFormat df = new DecimalFormat("#,##0.##");
            ...
            for (ModelPolarAreaChart data : list) {
                ...
                double rs = valuesToRealSize(data.getValues(), size)*0.8 *animate;
            ...
            int newX = (width - newSize) / 2; 
            int newY = (height - newSize) / 2; 
            g2.drawOval(newX, newY, newSize, newSize);
        }
        g2.dispose();
...
//
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thống kê độ tuổi trong phòng ban");
